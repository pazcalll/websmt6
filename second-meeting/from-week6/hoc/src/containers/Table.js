...
class Table extends Component{
    render(){
        return(
            <div className="col-lg-10 ofset-lg-1 col-md-10 col-sm-12 col-xs-12">
                                ...
                                <tr key={todo.id}>
                                    ...
                                    <td>
                                        <span className="btn btn-danger" onClick={()=>this.props.deleteTodo(todo.id)} 
                                            style={{color:"white", fontSize: "20pt", marginRight:"20px"}}>delete</span>
                                        <span className="btn btn-success" onClick={()=>this.props.toggleTodo(todo.id)} 
                                            style={{color:"white", fontSize: "20pt"}}>finish</span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>

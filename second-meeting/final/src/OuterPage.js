            ...
            <div className="central">
                <div className="sidebar bg-dark">
                    ...
                    <ul>
                        ...
                        <li><Link className="side-item" onClick={handleClick} to="/history">History</Link></li>
                        <li><Link className="side-item" onClick={handleClick} to="/account">Account</Link></li>
                    </ul>
                    {/* </div> */}
                </div>
                <div className="responsive-nav" style={{position: 'sticky', top: '0', zIndex: '2'}}>
                  
                  <nav className="navbar navbar-dark bg-secondary" style={{width: '100%',height:'100%', maxHeight:'100px', position: 'relative', marginTop:'0px'}}>
                      ...
                      {/* <Dropdown id="drop">
                          ...
                          <Dropdown.Menu>
                              <Dropdown.Item><Link  to="/guest">Guest</Link></Dropdown.Item>
                              <Dropdown.Item><Link  to="/user">User</Link></Dropdown.Item>
                          </Dropdown.Menu>
                      </Dropdown> */}
                      <form>
                        <a type="submit" className="btn btn-dark logout">Logout</a>
                      </form>
                  </nav>
                </div>
                {/* <Switch>
                ...
                {/* <hr style={{marginLeft: '215px', maxWidth: '1220px'}}/> */}
